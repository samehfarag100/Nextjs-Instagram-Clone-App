...
import useModelHook from "@/Hook/modelHook/useModelHook";
            ...
            >
              <div>
                {selectedFile ? (
                  ...
                  <div
                    // this to make a fake click on input his type (File)
                ...
                <div>
                  <div className="mt-3 text-center sm:mt-5">
                    <Dialog.Title
                      as="h3"
                      className="text-center sm:mt-5 cursor-pointer"
                    >
                      Upload Photo
                    </Dialog.Title>
              ...
              <div className="mt-5 sm:mt-6">
                <button
                 ...
                 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2
